...
namespace Game.Domain
{
    ...
    {
        [BsonElement] private readonly List<Player> players;
        ...
        [BsonConstructor] public GameEntity(Guid id, GameStatus status, int turnsCount, int currentTurnIndex, List<Player> players)
        {
            Id = id;
            Status = status;
        ...
        [BsonElement] public int TurnsCount { get; }
