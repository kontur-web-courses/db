...
namespace Game.Domain
{
    ...
    public class MongoGameRepository : IGameRepository
    {
        ...
        public GameEntity FindById(Guid gameId) => collection.Find(g => g.Id == gameId).SingleOrDefault();

        public void Update(GameEntity game) => collection.ReplaceOne(g => g.Id == game.Id, game);
